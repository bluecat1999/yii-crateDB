...
class PDO extends BasePDO implements PDOInterface
{
     ...
     const DSN_REGEX = '/^(?:crate:)(?:((?:[\w\.-]+:\d+\,?)+))\/?([\w]+)?$/';

     const CRATE_ATTR_HTTP_BASIC_AUTH = 1000;
     const CRATE_ATTR_DEFAULT_SCHEMA  = 1001;

     const CRATE_ATTR_SSL_MODE                                       = 1008;
     const CRATE_ATTR_SSL_MODE_DISABLED                              = 1;
     const CRATE_ATTR_SSL_MODE_ENABLED_BUT_WITHOUT_HOST_VERIFICATION = 2;
     const CRATE_ATTR_SSL_MODE_REQUIRED                              = 3;

     const CRATE_ATTR_SSL_KEY_PATH      = 1002;
     const CRATE_ATTR_SSL_KEY_PASSWORD  = 1003;
     const CRATE_ATTR_SSL_CERT_PATH     = 1004;
     const CRATE_ATTR_SSL_CERT_PASSWORD = 1005;
     const CRATE_ATTR_SSL_CA_PATH       = 1006;
     const CRATE_ATTR_SSL_CA_PASSWORD   = 1007;
    ...
    public function getAttribute($attribute)
    {
        switch ($attribute) {
            ...
            case self::CRATE_ATTR_SSL_CA_PATH:
                return isset($this->attributes['sslCa']) ?$this->attributes['sslCa']: null;

            case self::CRATE_ATTR_SSL_CA_PASSWORD:
                return isset($this->attributes['sslCaPassword']) ?$this->attributes['sslCaPassword']: null;

            case self::CRATE_ATTR_SSL_CERT_PATH:
                return isset($this->attributes['sslCert']) ?$this->attributes['sslCert']: null;

            case self::CRATE_ATTR_SSL_CERT_PASSWORD:
                return isset($this->attributes['sslCertPassword']) ?$this->attributes['sslCertPassword']: null;

            case self::CRATE_ATTR_SSL_KEY_PATH:
                return isset($this->attributes['sslKey']) ?$this->attributes['sslKey']: null;

            case self::CRATE_ATTR_SSL_KEY_PASSWORD:
                return isset($this->attributes['sslKeyPassword']) ?$this->attributes['sslKeyPassword']: null;
